...
const someValue = createSome("This is string").map((value) =>
  value.toUpperCase()
);
const nothValue = createNothing("This is nothing string").map((val) =>
  val.toUpperCase()
);

// console.log(someValue);
// console.log(nothValue);

function* gen() {
  return "First Generator";
}
const genResult = gen();
// console.log(genResult.next().value);
...
// console.log(conGen.next().value);
// console.log(conGen.next().value);
// console.log(conGen.next().value);

// for (let val of genGen()) {
//   console.log(val);
// }
...
const sayName = sayFullName();

console.log(sayName.next());
console.log(sayName.next("zinpaing"));
